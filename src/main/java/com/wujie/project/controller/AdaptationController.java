...
public class AdaptationController {
    ...
    public ResultInfo selectAdByBid(Integer pageNum,Integer pageSize,String bid){
        PageInfo<Adaptation> res = adaptationService.selectAdByBid(pageNum, pageSize, bid);
